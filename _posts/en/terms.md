...
By accessing bankstatementparser.com ("the Website") and using the Bank Statement Parser library ("the Software"), you agree to be bound by these Terms of Use. If you do not agree, please do not use the Website or Software.

## Open-Source Licence

The Bank Statement Parser library is released under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0). You may use, modify, and distribute the Software in accordance with that licence. The full licence text is available in the [GitHub repository](https://github.com/sebastienrousseau/bankstatementparser/blob/main/LICENSE).
...
- Use the Website to transmit malicious code or conduct denial-of-service attacks.
- Reproduce, duplicate, or resell any part of the Website without express written permission.

## Use of the Software

The Software is provided for parsing bank statement files locally on your own systems. You are solely responsible for:

- Ensuring your use of the Software complies with applicable laws and regulations.
- The accuracy and integrity of data processed by the Software.
- Securing any sensitive financial data processed using the Software.

## Intellectual Property

The Bank Statement Parser name, logo, and website content are the property of Sebastien Rousseau. The Software source code is licensed under Apache 2.0 as described above.

## Disclaimer of Warranties

THE SOFTWARE AND WEBSITE ARE PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NONINFRINGEMENT.

Bank Statement Parser disclaims any and all liability for errors, omissions, or inaccuracies in data processing. The Software is not a substitute for professional financial advice or auditing.

## Limitation of Liability

IN NO EVENT SHALL THE AUTHORS, COPYRIGHT HOLDERS, OR CONTRIBUTORS BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES ARISING FROM THE USE OF THE SOFTWARE OR WEBSITE.

## Third-Party Links

The Website may contain links to third-party websites (GitHub, PyPI, Google, Microsoft). We are not responsible for the content or privacy practices of these sites.
...
We may update these Terms from time to time. Changes will be posted on this page. Last updated: April 2026.

## Contact

If you have questions about these Terms, contact us at contact@bankstatementparser.com.
